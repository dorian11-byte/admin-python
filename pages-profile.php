<?php
  ...
  if (!isset($usuario)) {
    ...
    if (isset($usuario)) {
        $records = $conn->prepare('SELECT id, email, name, tel, password FROM users WHERE id = :id');
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/5.jpg" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php if(!empty($user)): ?> <?= $user['name'] ?> <?php endif; ?></h4>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <h4><?php if(!empty($user)): ?> <?= $user['name'] ?> <?php endif; ?></h4>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                        <h4><?php if(!empty($user)): ?> <?= $user['email'] ?> <?php endif; ?></h4>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Phone No</label>
                                        <div class="col-md-12">
                                            <h4><?php if(!empty($user)): ?> <?= $user['tel'] ?> <?php endif; ?></h4>
                                        </div>
                                    </div>                                    
                                </form>
                            </div>
